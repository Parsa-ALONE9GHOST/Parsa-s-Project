...
SMODS.Consumable({
    ...
    atlas = "minty",
	pos = { x = 0, y = 0, },
	config = { enh = "m_pal_mint_card", lim = 2 },
	discovered = true,
loc_txt = {
                name = "Mintation",
                text = {
                    "Enhances {C:attention}#1#{} selected cards",
                    "into {X:green,C:white}Mint{} Cards",
                }
            },
	loc_vars = function(self, info_queue)
		info_queue[#info_queue + 1] = G.P_CENTERS.m_pal_mint_card
    ...
    use = function(self, card)   -- For cons.(Thank you very much kirbio for this code :) )
        ...
        for i = 1, #G.hand.highlighted do
            G.E_MANAGER:add_event(Event({
                ...
                delay = 0.1,
                func = function()
                    G.hand.highlighted[i]:set_ability(G.P_CENTERS['m_pal_mint_card'])
                    return true
                end
            }))
        end
